...
func _ready() -> void:
	engage_area_left_fork.connect("engage_area_left_fork_entered", on_engage_area_left_fork_entered)
	engage_area_left_fork.connect("engage_area_left_fork_exited", on_engage_area_left_fork_exited)
	engage_area_right_fork.connect("engage_area_right_fork_entered", on_engage_area_right_fork_entered)
	engage_area_right_fork.connect("engage_area_right_fork_exited", on_engage_area_right_fork_exited)
